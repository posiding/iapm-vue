...
import OrgPositionEdit from './SysDictTypeEdit'
import { getRoleList } from '@/api/manage'
import { getDictTypeData } from '@/api/sys/sysDictApi'
import OrgPositionQuery from './SysDictQuery'
export default {
  ...
  data () {
    return {
      ...
      loadData: parameter => {
        return getDictTypeData(Object.assign(parameter, { queryPrams: this.queryBody }))
          .then(res => {
            return res.result
          })
      },
