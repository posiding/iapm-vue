  ...
  <div class="table-content">
    <div class="table-operator">
      <div class="button-group">
        <a-button type="primary" size="small" @click="$refs.sysMenuEdit.add()">新建</a-button>
      </div>
      <div class="search-group">
        <a-form layout="inline">
          <a-form-item label="菜单名称">
            <q-input opt="like" name="menuName" style="width: 140px;height: 28px;" :context="queryBody" placeholder="请输入菜单名称"/>
          </a-form-item>
          <a-form-item>
            <a-button-group>
    ...
    <sys-menu-edit ref="sysMenuEdit" @ok="handleOk"></sys-menu-edit>
      ...
      <a-form layout="inline" class="searchForm">
        ...
        <a-row :class="['searchRow']">
          <a-col :md="24" :sm="24" :style="{ textAlign: 'center', margin: '10px 0px' }">
            <a-button size="small" type="primary" @click="execSearch()">查询</a-button>
...
import { getData } from '@/api/sys/sysMenuApi'
import OrgPositionQuery from './SysMenuQuery'
export default {
  name: 'SysMenuList',
  components: {
    STable,
